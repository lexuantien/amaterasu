...
func (scb SyncCommandBus) Send(ctx context.Context, command v2messaging.Envelop) error {
...
func (scb SyncCommandBus) Sends(ctx context.Context, commands ...v2messaging.Envelop) error {
	// pending command
	for len(commands) > 0 {
...
func (scb SyncCommandBus) doSend(command v2messaging.Envelop) bool {
	handled := false
