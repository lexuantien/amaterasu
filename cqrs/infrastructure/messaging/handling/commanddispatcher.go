...
*/
type commandHandlerFunc func(msg messaging.Message) error
...
type CommandDispatcher struct {
	...
	commandHandlers map[reflect.Type]messaging.ICommandHandler
...
func New_CommandDispatcher() *CommandDispatcher {
	return &CommandDispatcher{
		commandHandlers:     make(map[reflect.Type]messaging.ICommandHandler),
...
func (cd *CommandDispatcher) Register(commandHandler messaging.ICommandHandler) error {
